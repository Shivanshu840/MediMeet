        ...
        <nav className="mx-auto max-w-7xl flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {session ? (
              ...
              <Link
                className="text-zinc-200 hover:text-white transition-colors hidden sm:inline-block"
                href="/signin"
              >
                Log in
              </Link>
            ...
            <Button
              className="bg-white text-zinc-900 hover:bg-zinc-200"
              onClick={() =>
                router.push("https://medi-meet-docs-rho.vercel.app")
              }
            >
              Admin Panel
            </Button>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <p className="text-zinc-400 max-w-md">
                MediMeet is an innovative telemedicine platform connecting
                patients with top healthcare consultants for expert advice and
                care. Since 2024, we've been dedicated to providing accessible,
                high-quality medical consultations, ensuring you get the right
                guidance without leaving home. Whether you need advice on
                complex conditions, follow-up consultations, or urgent health
                concerns, MediMeet is here to connect you with experienced
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            <div className="p-6 rounded-lg bg-white/5">
              <h3 className="text-emerald-400 text-lg font-medium mb-2">
                Online consultations
              </h3>
              <p className="text-zinc-400">
                Connect with our doctors remotely for expert medical advice.
              </p>
            </div>
            <div className="p-6 rounded-lg bg-white/5">
              <h3 className="text-emerald-400 text-lg font-medium mb-2">
            ...
            <div className="p-6 rounded-lg bg-white/5">
              ...
              <p className="text-zinc-400">
                Access comprehensive medical resources and information.
              </p>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="group relative rounded-3xl p-8 bg-gradient-to-br from-emerald-100/20 to-blue-100/20 backdrop-blur-sm overflow-hidden">
                ...
                <p className="text-zinc-300">
                  Our experience of treating millions of patients each year
                  prepares us to take care of the one who matters most - you.
                </p>
              ...
              <div className="group relative rounded-3xl p-8 bg-zinc-900/80 backdrop-blur-sm">
                ...
                <p className="text-zinc-300 mb-6">
                  We employ the best specialists. Would you like to get to know
                  our employees?
                </p>
