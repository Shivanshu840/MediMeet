  ...
  return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-blue-50 flex items-center justify-center p-4">
          <Card className="w-full max-w-md">
              <CardHeader>
                  <CardTitle className="text-2xl font-bold text-center">Video Sender</CardTitle>
              </CardHeader>
              <CardContent>
                  <div className="flex flex-col items-center space-y-4">
                      ...
                      <div className="flex space-x-2">
                          <Button 
                              ...
                              className={stream ? "bg-red-500 hover:bg-red-600" : "bg-green-500 hover:bg-green-600"}
                          >
                      ...
                      {isSending && (
                          <p className="text-sm text-emerald-600">Video stream is being sent...</p>
                      )}
                  </div>
              </CardContent>
          </Card>
